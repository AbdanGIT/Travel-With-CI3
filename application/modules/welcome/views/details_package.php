...
<body>
    ...
    <div class="container mt-4">
        <div class="jumbotron text-center">
            <img class="card-img-top" src="<?= base_url('') ?>assets/img/<?= $this->input->get('icon') ?>.png"
                alt="Card image" style="max-width:150px;"><br>
            <small>PACKAGE ID:
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis assumenda velit nobis, voluptas
                repellendus quam, sunt quasi praesentium repellat nulla commodi hic quo atque. Repudiandae, qui!
                Voluptatum error animi quam.</p>
            ...
            <form id="payment-form" method="post" action="<?= site_url() ?>/snap/finish">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="Guest"
                        required>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Email address</label>
                    <input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp"
                        value="guest@mail.com" placeholder="Enter email" required>
