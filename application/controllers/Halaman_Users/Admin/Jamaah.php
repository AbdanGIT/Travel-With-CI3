...
class Jamaah extends CI_Controller
{
	...
	function simpan_jamaah()
	{
		...
		$this->m_jamaah->simpan_jamaah($nama_ktp, $nama_paspor, $no_identitas, $no_tlp, $nama_ayah, $email, $tanggal_lahir, $jenis_kelamin, $kewarganegaraan, $tempat_lahir, $alamat, $pendidikan, $provinsi, $kota, $kecamatan, $kelurahan, $kategori_usia, $status_menikah, $pekerjaan, $status_keluarga, $ukuran_baju, $tipe_anggota, $porsi, $penyiar, $perwakilan);
		echo $this->session->set_flashdata('msg', 'success');
		redirect('halaman_users/admin/jamaah');
	}
	...
	function update_jamaah()
	{
		...
		if (!empty($_FILES['filefoto']['name'])) {
			if ($this->upload->do_upload('filefoto')) {
				...
				$this->m_jamaah->update_jamaah($kode, $nama_paspor, $no_identitas, $no_tlp, $nama_ayah, $email, $tanggal_lahir, $jenis_kelamin, $kewarganegaraan, $tempat_lahir, $alamat, $pendidikan, $provinsi, $kota, $kecamatan, $kelurahan, $kategori_usia, $status_menikah, $pekerjaan, $status_keluarga, $ukuran_baju, $tipe_anggota, $porsi, $penyiar, $perwakilan);
