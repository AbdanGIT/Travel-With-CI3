...
class paket extends CI_Controller
{
    ...
    function index()
    {
        ...
        $this->load->view('halaman_users/kphg/v_paket', $x);
    ...
    function simpan_paket()
    {
        ...
        if (!empty($_FILES['filefoto']['name'])) {
            if ($this->upload->do_upload('filefoto')) {
                ...
                redirect('halaman_users/kphg/paket');
            } else {
            ...
            $this->m_paket->simpan_paket($nama_paket, $tgl_keberangkatan, $tgl_kembali, $kota_keberangkatan, $hotel, $maskapai, $harga, $porsi, $keterangan);
            echo $this->session->set_flashdata('msg', 'success');
            redirect('halaman_users/kphg/paket');
        }
    }
