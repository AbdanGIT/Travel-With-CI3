...
class Login extends CI_Controller
{
    ...
    function index()
    {
        $this->load->view('halaman_users/v_login');
    }
    function auth()
    {
        ...
        if ($cadmin->num_rows() > 0) {
            ...
            if ($xcadmin['pengguna_level'] == '1') {
                ...
                redirect('halaman_users/admin/dashboard');
            } 
                ...
                $this->session->set_userdata('idadmin', $idadmin);
                $this->session->set_userdata('nama', $user_nama);
                redirect('halaman_users/kphg/dashboard');
            } 
                ...
                $this->session->set_userdata('idadmin', $idadmin);
                $this->session->set_userdata('nama', $user_nama);
                redirect('halaman_users/penyiar/dashboard');
            } 
