...
<body class="hold-transition login-page">
  <div class="register-box">
    ...
    <div class="register-box-body">
      <p class="register-box-msg"> <img width="320px;" src="<?php echo base_url() . 'assets/images/logo.png' ?>"></p>
      <hr />
      <p>BUAT AKUN</p>
      ...
      <center>Sudah memiliki akun?<a href="<?= base_url('administrator'); ?>">Login!!</a><br><a href="<?= base_url(); ?>halaman_users/lupa_password">Lupa Password</a></center>
      <div class="col-xs-10">
      </div>
      <!-- /.social-auth-links -->
      <hr />
