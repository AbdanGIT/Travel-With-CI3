                ...
                <tbody>
                  <?php foreach ($data->result_array() as $i):
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $pengguna_username; ?>
                      </td>
                      <td>
                        <?php echo $pengguna_email; ?>
                      </td>
                      ...
                      <?php endif; ?>
                      <td>
                        <?php echo $pengguna_password; ?>
                      </td>
                      <td>
                        <?php echo $pengguna_nohp; ?>
                      </td>
                      ...
                      <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $pengguna_id; ?>"><span
                            class="fa fa-pencil"></span></a>
                        <a class="btn"
                          href="<?php echo base_url() . 'halaman_users/admin/daftar/reset_password/' . $pengguna_id; ?>"><span
                            class="fa fa-refresh"></span></a>
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $pengguna_id; ?>"><span
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/admin/daftar/simpan_pengguna' ?>"
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xnama" class="form-control" id="inputUserName" placeholder="Nama Lengkap"
                required>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xusername" class="form-control" id="inputUserName" placeholder="Username"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="password" name="xpassword" class="form-control" id="inputPassword3" toggle="#inputPassword3"
                placeholder="Password" toggle="#inputPassword3" class><span toggle="#inputPassword3"
                class="toggle-password fa fa-eye"></span></input>
            </div>
          </div>
          ...
          <script>
            ...
            // Mengambil elemen toggle mata
            const togglePasswordIcons = document.querySelectorAll('.toggle-password');

            // Menambahkan event listener untuk setiap elemen toggle mata
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xkontak" class="form-control" id="inputUserName" placeholder="Kontak Person"
                required>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <select class="form-control" name="xlevel" placeholder="pilih" required>
  ...
  <div class="modal fade" id="ModalEdit<?php echo $pengguna_id; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/admin/daftar/update_pengguna' ?>"
          method="post" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputEmail3" class="col-sm-4 control-label">Email</label>
              <div class="col-sm-7">
                <input type="email" name="xemail" class="form-control" value="<?php echo $pengguna_email; ?>"
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Username</label>
              <div class="col-sm-7">
                <input type="text" name="xusername" class="form-control" value="<?php echo $pengguna_username; ?>"
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Kontak Person</label>
              <div class="col-sm-7">
                <input type="text" name="xkontak" class="form-control" value="<?php echo $pengguna_nohp; ?>"
                  id="inputUserName" placeholder="Kontak Person" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Level</label>
              <div class="col-sm-7">
                <select class="form-control" name="xlevel" required>
                  ...
                  <?php elseif ($pengguna_level == '2'): ?>
                    <option value="1">Administrator</option>
                    <option value="2" selected>KPHG</option>
                    <option value="3">Penyiar</option>
                    <option value="4">Jamaah</option>
                  <?php elseif ($pengguna_level == '3'): ?>
                    <option value="1">Administrator</option>
                    <option value="2">KPHG</option>
                    <option value="3" selected>Penyiar</option>
                    <option value="4">Jamaah</option>
                  <?php else: ?>
                    <option value="1">Administrator</option>
                    <option value="2">KPHG</option>
  ...
  <div class="modal fade" id="ModalHapus<?php echo $pengguna_id; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/admin/daftar/hapus_pengguna' ?>"
          method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <input type="hidden" name="kode" value="<?php echo $pengguna_id; ?>" />
      ...
      <div class="modal-body">
        ...
        <table>
          <tr>
            ...
            <th>:</th>
            <th>
              <?php echo $this->session->flashdata('uname'); ?>
            </th>
          ...
          <tr>
            ...
            <th>:</th>
            <th>
              <?php echo $this->session->flashdata('upass'); ?>
            </th>
          </tr>
        </table>
