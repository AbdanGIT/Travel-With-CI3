        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'halaman_users/admin/tulisan/add_tulisan'?>"><span class="fa fa-plus"></span> Post Tulisan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:19px;">
                <thead>
                <tr>
      					<th>Gambar</th>
      					<th>Judul</th>
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'halaman_users/admin/tulisan/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'halaman_users/admin/tulisan/hapus_tulisan'?>" method="post" enctype="multipart/form-data">
