...
<body class="hold-transition login-page">
  <div class="register-box">
    ...
    <div class="register-box-body">
      ...
      <form action="<?php echo site_url() . 'halaman_users/register/simpan_pengguna' ?>" method="post">
        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="col-xs-7">
              <a href="<?= base_url(); ?>">
                <input type="button" class="btn btn-primary btn-block btn-flax" value="kembali">
              </a>
            </div>
          </div>
          <!-- /.col -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <center>Sudah memiliki akun?<a href="<?= base_url('administrator'); ?>">Login!!</a></center>
        </div>
      </div>
      <div class="col-xs-10">
      </div>
