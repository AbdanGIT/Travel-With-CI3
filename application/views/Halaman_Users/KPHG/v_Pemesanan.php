...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/kphg/pemesanan/simpan_pemesanan' ?>" method="post" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xkota_keberangkatan" class="form-control" id="kotakeberangkatan" placeholder="Kota Keberangkatan" required readonly>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xtgl_keberangkatan" class="form-control" id="berangkat" placeholder="Tanggal Berangkat" required readonly>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xtgl_kembali" class="form-control" id="kembali" placeholder="Tanggal Kembali" required readonly>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xketerangan" class="form-control" id="keterangan" placeholder="Kategori" required readonly>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="xharga" class="form-control" id="harga" placeholder="Total Harga" required readonly>
            </div>
          </div>
  ...
  <div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/kphg/pemesanan/update_pemesanan' ?>" method="post" enctype="multipart/form-data">
          <?php
          ...
          ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select name="xnama_paspor" class="form-control" required>
                    ...
                    ?>
                      <option value="<?php echo $id_jamaah; ?>" <?php echo $selected; ?>><?php echo $nama_paspor_jamaah; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <select name="xjenis_pemesanan" class="form-control" required>
                    <option value="">-Pilih-</option>
                    <option value="Cicilan ke-3" <?php if ($jenis_pemesanan == 'Cicilan ke-3') echo 'selected'; ?>>Cicilan ke-3</option>
                    <option value="Cicilan ke-6" <?php if ($jenis_pemesanan == 'Cicilan ke-6') echo 'selected'; ?>>Cicilan ke-6</option>
                    <option value="Cicilan ke-9" <?php if ($jenis_pemesanan == 'Cicilan ke-9') echo 'selected'; ?>>Cicilan ke-9</option>
                  </select>
                </div>
              </div>
  ...
  <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url() . 'halaman_users/kphg/pemesanan/hapus_pemesanan' ?>" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            <input type="hidden" name="kode" value="<?php echo $id; ?>" />
            <p>Apakah Anda yakin mau menghapus pemesanan <b><?php echo $nama_paspor; ?></b> ?</p>
