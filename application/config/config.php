...
|
*/
$config['base_url'] = 'http://localhost/M/Tugasakhir/';
...
$config['midtrans_server_key'] = 'SB-Mid-server-_ODFWGTaaVOl_r3wIVTG2dEj';
$config['midtrans_client_key'] = 'SB-Mid-client-KhFCAz9zKjFT3KfB';